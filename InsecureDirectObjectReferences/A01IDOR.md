...
Під час виконання лабораторної роботи я на практиці дослідила вразливість Insecure Direct Object References (IDOR). Проаналізувавши REST-архітектуру додатка та перехопивши HTTP-запити за допомогою Burp Suite, я виявила відсутність належної перевірки прав доступу на стороні сервера. Шляхом маніпуляції з прямими посиланнями — числовими ідентифікаторами користувачів (`userId`) — мені вдалося успішно обійти механізми авторизації та отримати несанкціонований доступ до чужих профілів. Ця робота наочно продемонструвала, наскільки важливо реалізовувати суворий контроль доступу до об'єктів виключно на серверному рівні, а не покладатися на приховування даних в інтерфейсі клієнта.
