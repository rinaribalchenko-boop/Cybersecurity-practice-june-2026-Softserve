...
Починаю проходження завдань. Легітимна автентифікація, після буду шукати способи обходу авторизації або зловжити нею. Логін та пароль для цього облікового запису — tom та cat

Після проходження автентифікації переходжу до наступного екрана.
